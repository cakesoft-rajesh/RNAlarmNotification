...
class AlarmUtil {
    ...
    void sendNotification(AlarmModel alarm) {
        try {
            ...
            if(alarm.getSoundName().equals("azan.mp3")){
             mBuilder.setSound(Uri.parse("android.resource://com.zocial.uin/raw/azan"));
            }else if(alarm.getSoundName().equals("dummy.mp3")){
             mBuilder.setSound(Uri.parse("android.resource://com.zocial.uin/raw/dummy"));
            }else if(alarm.getSoundName().equals("default")){
             mBuilder.setSound(RingtoneManager.getDefaultUri(RingtoneManager.TYPE_NOTIFICATION));
            } else{
             mBuilder.setSound(Uri.parse(alarm.getSoundName()));
            }
